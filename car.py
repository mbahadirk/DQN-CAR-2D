import pygame
from CFG import WHITE,WIDTH,HEIGHT,CAR_IMAGE_PATH
import math
...
class Car:
    ...
    def draw(self, surface):
        ...
        pygame.draw.rect(collider_surface, (255, 0, 0, 128), collider_surface.get_rect())  # Yarı saydam kırmızı
    ...
    def collide(self, mask, x=0, y=0, surface = None):
        rotated_car = pygame.transform.rotate(self.car_image, -self.angle)
        rect = rotated_car.get_rect(center=(self.x, self.y))
